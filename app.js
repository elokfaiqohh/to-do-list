...
class Reminder {
  ...
  class TaskManager {
    ...
    addEventListeners() {
      ...
      // Menambahkan event listener untuk mendeteksi Enter
    ...
    editTask(taskId) {
      ...
      if (newTitle) {
        ...
        document
          ...
          .querySelector(".task-info").textContent = `${
          task.title
    ...
    scheduleReminders(task) {
      ...
      if (delayBefore > 0) {
        ...
        console.log(
          "Pengingat 5 menit sebelumnya sudah lewat, tetapi pengingat pada waktu yang diatur akan tetap diatur."
        );
      } else {
